...
<div class="content">
    ...
    <?= $form->field($loginForm, 'username')->textInput(['placeholder' => 'Username'])->label(false) ?>
    ...
    <?= $form->field($passwordResetRequestForm, 'email')->textInput(['placeholder' => 'Email'])->label(false) ?>
